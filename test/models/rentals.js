...
describe('Rental', function() {
 ...
 beforeEach(function(done) {
   ...
   db_cleaner.serialize(function() {
     db_cleaner.exec("BEGIN; DELETE FROM customers; DELETE FROM rentals; INSERT INTO customers(name, registered_at, address, city, state, postal_code, phone, account_credit) VALUES('Mulder', '2013-12-23', '123', 'DC', 'DC', '834885', '49583', 5), ('Scully', '2015-09-16', '12 blah','DC', 'DC', '2342', '534', 7); INSERT INTO rentals(movie_id, customer_id, returned_date, due_date, checked_out) VALUES(1, 1, '', '2015-09-10', '2015-09-01'), (2, 2, '2015-10-01', '2015-09-29', '2015-09-19'); COMMIT;", function(err) {
         db_cleaner.close();
         done();
       }
     );
